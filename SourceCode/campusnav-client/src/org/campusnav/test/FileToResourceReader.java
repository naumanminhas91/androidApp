...
//	}
	...
	public HashMap<Integer, WiFiCoordinate> discretePointFileReader(
			String file_name) {
		FileReader fr;
		BufferedReader br;
		...
		InputStream iStreamFile1 = MainActivity.context.getResources().openRawResource(R.raw.newfilecoordinate);
